...
export const Textarea = React.forwardRef<HTMLDivElement, TextareaProps>(
  (
    ...
    const textareaColor = objectsToString(
      textareaVariant.colors.textarea[
        findMatch(valid.colors, color, "AtomGray300")
      ]
    )
    ...
    const textareaClasses = classnames(
      ...
      objectsToString(
        textareaVariant.sizes[findMatch(valid.sizes, size, "md")].textarea
      ),
    ...
    const labelClasses = classnames(
      ...
      objectsToString(
        textareaVariant.sizes[findMatch(valid.sizes, size, "md")].label
      ),
...
Textarea.displayName = "AtomStyle.Textarea"
