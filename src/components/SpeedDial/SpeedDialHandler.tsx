...
export interface SpeedDialHandlerProps
  extends React.HTMLAttributes<HTMLElement> {}

export const SpeedDialHandler = React.forwardRef<
  HTMLElement,
  SpeedDialHandlerProps
>(({ children, ...rest }, ref) => {
  // 1. init
...
SpeedDialHandler.displayName = "AtomStyle.SpeedDialHandler"
