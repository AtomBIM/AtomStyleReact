...
export const Rating = React.forwardRef<HTMLDivElement, RatingProps>(
  (
    ...
    const ratingClasses = twMerge(
      classnames(objectsToString(base.rating), className)
    )
      ...
      React.cloneElement(ratedIconInstance, {
        className: twMerge(
          classnames(
            ratingIconClasses,
            ratedColorClasses,
            ratedIconInstance?.props?.className
          )
        ),
      })
      ...
      React.cloneElement(unratedIconInstance, {
        className: twMerge(
          classnames(
            ratingIconClasses,
            unratedColorClasses,
            unratedIconInstance?.props?.className
          )
        ),
      })
        ...
        return React.createElement(
          "span",
          {
            ...
            onClick: () => {
              ...
              const nextRating = ratingValue.map((el, i) =>
                i <= index ? "rated" : "un_rated"
              )
            ...
            onMouseEnter: () => {
              ...
              const nextRating = ratingOnHover.map((el, i) =>
                i <= index ? "rated" : "un_rated"
              )
...
Rating.displayName = "AtomStyle.Rating"
