...
const Select = React.forwardRef<HTMLDivElement, SelectProps>(
  (
    ...
    const selectColor =
      selectVariant.colors.select[findMatch(valid.colors, color, "AtomGray300")]
    const labelError = selectVariant.error.label
    const labelSuccess = selectVariant.success.label
    const labelColor =
      selectVariant.colors.label[findMatch(valid.colors, color, "AtomGray300")]
      ...
      <SelectContextProvider value={contextValue}>
        <div {...containerProps} ref={ref} className={containerClasses}>
          ...
          >
            ...
            <div>{arrow ?? <ChevronDownIcon className={arrowClasses} />}</div>
          </button>
...
Select.displayName = "AtomStyle.Select"
