...
export type iconChecked = ReactNode
export type iconUnchecked = ReactNode
...
export const propTypesIconChecked: any = PropTypes.node
export const propTypesIconUnchecked: any = PropTypes.node
