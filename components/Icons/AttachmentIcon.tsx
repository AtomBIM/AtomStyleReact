...
export const AttachmentIcon = React.forwardRef<HTMLElement, IconProps>(
  ({ size, className }) => {
    size = size ?? 24
    className = className
...
AttachmentIcon.displayName = "AtomStyle.AttachmentIcon"
