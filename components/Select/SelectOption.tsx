...
export const SelectOption = ({
  ...
  return (
    ...
    >
      <div className="flex justify-between items-center h-6 max-h-6 overflow-visible">
        {children}
        {selectedIndex === index && (
          <CheckIcon className="overflow-visible h-5 w-5 fill-AtomRed" />
        )}
      </div>
    </li>
  )
...
SelectOption.displayName = "AtomStyle.SelectOption"
