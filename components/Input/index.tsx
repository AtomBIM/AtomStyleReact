...
export const Input = React.forwardRef<HTMLInputElement, InputProps>(
  (
    ...
    const inputColor = objectsToString(
      inputVariant.colors.input[findMatch(valid.colors, color, "AtomGray300")]
    )
    ...
    const labelColor = objectsToString(
      inputVariant.colors.label[findMatch(valid.colors, color, "AtomGray300")]
    )
...
Input.displayName = "AtomStyle.Input"
