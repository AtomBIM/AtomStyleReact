...
export const propTypesDefaultValue: any = PropTypes.oneOfType([
  PropTypes.number,
  PropTypes.string,
])
...
export const propTypesMin: any = PropTypes.oneOfType([
  PropTypes.number,
  PropTypes.string,
])
export const propTypesMax: any = PropTypes.oneOfType([
  PropTypes.number,
  PropTypes.string,
])
export const propTypesStep: any = PropTypes.oneOfType([
  PropTypes.number,
  PropTypes.string,
])
